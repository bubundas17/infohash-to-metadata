...
(0, index_js_1.default)(INFO_HASH, { maxConns: 100, fetchTimeout: 30000, socketTimeout: 5000 }, (err, metadata) => {
    if (err) {
        console.log(err);
        return;
    }
...
(0, index_js_1.default)(INFO_HASH, { maxConns: 100, fetchTimeout: 30000, socketTimeout: 5000, dht })
    .then(metadata => {
...
// Re-use DHT instance.
(0, index_js_1.default)(INFO_HASH2, { maxConns: 100, fetchTimeout: 30000, socketTimeout: 5000, dht })
    .then(metadata => {
    console.log(`[Promise] ${metadata}`);
}).catch(err => {
    console.log(err);
